...
void collision()
{ // the collision check is actually done befor this is called, this code works out where the ball will bounce
...
void loop()
{
  ...
  while (digitalRead(0) == HIGH)
  {
    ...
    if (nowT - startT > 2000)
    {
      ...
      {
        mute = 1;
        ssd1306_char_f6x8(32, 1, "-- MUTE --");
      }
      else
      {
        mute = 0;
        ssd1306_char_f6x8(23, 1, "-- SOUND ON --");
      }
      break;
    }
    if (sChange == 1)
